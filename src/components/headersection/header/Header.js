    ...
    return (
        <div className="w-100 flex flex-column flex-row-ns justify-between-ns pb2 bg-light-blue ma0 "> {/*bb b--moon-gray*/} 
            ...
            <ul className="w-100 flex justify-start justify-end-ns ma0 list pl0">
                <li className="pl2 pr3 pt1"><a className="link white-60 bg-transparent hover-white inline-flex items-center ma2 tc br2 pa2" href="https://github.com/mrmrs" title="GitHub">
      ...
      <span className="f6 ml3 pr2"></span>
                ...
                <li className="pr3 pt1"><a className="link white-60 bg-transparent hover-white inline-flex items-center ma2 tc br2 pa2" href="https://linkedin.com" title="LinkedIn">
